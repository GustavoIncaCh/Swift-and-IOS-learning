...
//  CloneBank
//
//  Created by desarrollador11 on 8/06/22.
//

import SwiftUI

struct customTopTabBar: View {
    @Binding var currentTab: Payment
    var body: some View {
        GeometryReader{
            proxy in
            HStack(alignment: .center, spacing: 0){
                ForEach(Payment.allCases, id: \.rawValue){
                    tab in
                    Button{
                        ...
                        Text(tab.rawValue)
                            ...
                            // a padding value
                            .frame(minWidth: UIScreen.screenWidth/CGFloat(Payment.allCases.count)-20)
                    }
    ...
    func indicatorOffSet(width: CGFloat)->CGFloat{
        ...
        let buttonWidth = width / CGFloat(Payment.allCases.count)
